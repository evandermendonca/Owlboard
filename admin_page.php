...
while($result=$entries->fetch_array())
{
    ...
    <div class="items-container">
        ...
        <div class="item-element" id="link">
            <span><a href="http://lamp.cse.fau.edu/~cen4010fal19_g08/view_post.php?id=$post_id">View Post</a></span>
        </div>
        <div class="item-element" id="link">
            <span><a href = "http://lamp.cse.fau.edu/~cen4010fal19_g08/edit_post.php?id=$post_id">Edit Post/Update Status</a> </span>
        </div>
    </div>
    </div>
EOL;
...
while($result=$entries->fetch_array())
{
    ...
    <div class="items-container" id="report-item">
        ...
        <div class="item-element" id="status">
            <span><a href="http://lamp.cse.fau.edu/~cen4010fal19_g08/edit_post.php?id=$post_id">Delete / Edit Post</a></span>
        </div>
    </div>
    </div>
EOL;
...
if(isset($_SESSION['logged']) and isset($_SESSION['user']) and isset($_SESSION['admin']))
{
  if($_SESSION['admin'] =="0")
{
  ...
  else
  {
    ...
    $query_string = "SELECT * FROM Posts WHERE (post_resolution !='Completed') AND post_category = 'Complaint' ORDER BY time_posted DESC";
    $query_string2 = "SELECT * FROM Reports";
...
<script>
  ...
  gtag('config', 'UA-153768096-1');
        ...
        <meta charset="utf-8">
        <title>Owlboard | Admin Page</title>
